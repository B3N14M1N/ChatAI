...
from ..models.schemas import Message, RequestResponsePair
...
class ContextService:
    ...
    async def get_compact_conversation_context(
        ...
        """
        page = await self.repo.list_messages(conversation_id, offset=0, limit=max_messages)
        prompt_msgs = []
        for m in page.items:
    ...
    async def get_last_n_pairs(self, conversation_id: int, n: int) -> List[RequestResponsePair]:
